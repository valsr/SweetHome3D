...
public class ColorButton extends JButton
{
	...
	public ColorButton(final UserPreferences preferences)
	{
		...
		addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ev)
			{
				...
				colorChooser.setColor(color != null ? new Color(color) : getBackground());
				JDialog colorDialog = JColorChooser.createDialog(getParent(), colorDialogTitle, true, colorChooser,
						new ActionListener()
						{
		...
		if (preferences != null)
		{
			...
			colorChooser = new JColorChooser(colorSelectionModel)
			{
				public void updateUI()
				{
					...
					if (chooserPanels.get(0).getClass().getName()
	...
	private static class PalettesColorChooserPanel extends AbstractColorChooserPanel
	{
		...
		protected void buildChooser()
		{
			...
			JLabel colorLabel = new JLabel(this.preferences.getLocalizedString(ColorButton.class, "colorLabel.text"));
				...
				public void actionPerformed(ActionEvent ev)
				{
					...
					try
					{
						...
						else if (OperatingSystem.isJavaVersionGreaterOrEqual("1.6"))
						{
							...
							awtUtilitiesClass.getMethod("setWindowOpacity", Window.class, float.class).invoke(null,
									pipetteWindow, 0.05f);
							// Enlarge window to reduce mouse cursor change
							pipetteWindow.setSize(10, 10);
						}
			...
			JLabel rgbLabel = new JLabel(
					SwingTools.getLocalizedLabelText(this.preferences, ColorButton.class, "rgbLabel.text"));
			...
			JLabel ralLabel = new JLabel(
					SwingTools.getLocalizedLabelText(this.preferences, ColorButton.class, "ralLabel.text"));
			...
			{
				rgbLabel.setDisplayedMnemonic(KeyStroke
						.getKeyStroke(this.preferences.getLocalizedString(ColorButton.class, "rgbLabel.mnemonic"))
						.getKeyCode());
				rgbLabel.setLabelFor(this.rgbTextField);
				ralLabel.setDisplayedMnemonic(KeyStroke
						.getKeyStroke(this.preferences.getLocalizedString(ColorButton.class, "ralLabel.mnemonic"))
						.getKeyCode());
				ralLabel.setLabelFor(this.ralComboBox);
				creativeCommonsLabel.setDisplayedMnemonic(KeyStroke
						.getKeyStroke(
								this.preferences.getLocalizedString(ColorButton.class, "creativeCommonsLabel.mnemonic"))
						.getKeyCode());
			...
			add(this.grayColorChart, new GridBagConstraints(0, 0, 1, 7, 0, 0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
			add(this.colorChart, new GridBagConstraints(1, 0, 1, 7, 0, 0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 0, 10), 0, 0));
			add(colorLabel, new GridBagConstraints(2, 0, 1, 1, 0, 0, labelAlignment, GridBagConstraints.NONE,
					new Insets(0, 0, 8, 5), 0, 0));
			add(this.colorComponent, new GridBagConstraints(3, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
					GridBagConstraints.HORIZONTAL, new Insets(0, 0, 8, 0), 0, 0));
			add(pipetteButton, new GridBagConstraints(4, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
					GridBagConstraints.NONE, new Insets(0, 5, 8, 0), 0, 0));
			add(rgbLabel, new GridBagConstraints(2, 1, 3, 1, 0, 0, labelAlignment, GridBagConstraints.NONE,
					new Insets(0, 0, 2, 0), 0, 0));
			add(this.rgbTextField,
					new GridBagConstraints(2, 2, 3, 1, 0, 0, GridBagConstraints.LINE_START,
							GridBagConstraints.HORIZONTAL,
							OperatingSystem.isMacOSX() ? new Insets(0, 1, 5, 1) : new Insets(0, 0, 5, 0), 0, 0));
			add(ralLabel, new GridBagConstraints(2, 3, 3, 1, 0, 0, labelAlignment, GridBagConstraints.NONE,
					new Insets(0, 0, 2, 0), 0, 0));
			add(this.ralComboBox, new GridBagConstraints(2, 4, 3, 1, 0, 0, GridBagConstraints.LINE_START,
					GridBagConstraints.HORIZONTAL, new Insets(0, 0, 5, 0), 0, 0));
			add(creativeCommonsLabel, new GridBagConstraints(2, 5, 3, 1, 0, 0, labelAlignment, GridBagConstraints.NONE,
					new Insets(0, 0, 2, 0), 0, 0));
			add(this.creativeCommonsComboBox, new GridBagConstraints(2, 6, 3, 1, 0, 0, GridBagConstraints.LINE_START,
		...
		private void clickOnOk()
		{
			JRootPane rootPane = (JRootPane) SwingUtilities.getAncestorOfClass(JRootPane.class,
					PalettesColorChooserPanel.this);
			if (rootPane != null)
			{
	...
	private static final class ColorChart extends JComponent
	{
		...
		public Color getColorAt(int x, int y)
		{
			...
			{
				return Color.getHSBColor((float) x / (drawnWidth - 1),
						(float) (drawnHeight - 1 - y) / (drawnHeight - 1) * 2, 1);
			}
		}
		...
		public String getToolTipText(MouseEvent ev)
		{
			String color = String.format("#%6X", getColorAt(ev.getX(), ev.getY()).getRGB() & 0xFFFFFF).replace(' ',
					'0');
	...
	private static final class ColorCode
	{
		...
		public static final ColorCode RAL_COLORS[] = { new ColorCode("1000", 0xBEBD7F), new ColorCode("1001", 0xC2B078),
				new ColorCode("1002", 0xC6A664), new ColorCode("1003", 0xE5BE01), new ColorCode("1004", 0xCDA434),
				new ColorCode("1005", 0xA98307), new ColorCode("1006", 0xE4A010), new ColorCode("1007", 0xDC9D00),
				new ColorCode("1011", 0x8A6642), new ColorCode("1012", 0xC7B446), new ColorCode("1013", 0xEAE6CA),
				new ColorCode("1014", 0xE1CC4F), new ColorCode("1015", 0xE6D690), new ColorCode("1016", 0xEDFF21),
				new ColorCode("1017", 0xF5D033), new ColorCode("1018", 0xF8F32B), new ColorCode("1019", 0x9E9764),
				new ColorCode("1020", 0x999950), new ColorCode("1021", 0xF3DA0B), new ColorCode("1023", 0xFAD201),
				new ColorCode("1024", 0xAEA04B), new ColorCode("1026", 0xFFFF00), new ColorCode("1027", 0x9D9101),
				new ColorCode("1028", 0xF4A900), new ColorCode("1032", 0xD6AE01), new ColorCode("1033", 0xF3A505),
				new ColorCode("1034", 0xEFA94A), new ColorCode("1035", 0x6A5D4D), new ColorCode("1036", 0x705335),
				new ColorCode("1037", 0xF39F18), new ColorCode("2000", 0xED760E), new ColorCode("2001", 0xC93C20),
				new ColorCode("2002", 0xCB2821), new ColorCode("2003", 0xFF7514), new ColorCode("2004", 0xF44611),
				new ColorCode("2005", 0xFF2301), new ColorCode("2007", 0xFFA420), new ColorCode("2008", 0xF75E25),
				new ColorCode("2009", 0xF54021), new ColorCode("2010", 0xD84B20), new ColorCode("2011", 0xEC7C26),
				new ColorCode("2012", 0xE55137), new ColorCode("2013", 0xC35831), new ColorCode("3000", 0xAF2B1E),
				new ColorCode("3001", 0xA52019), new ColorCode("3002", 0xA2231D), new ColorCode("3003", 0x9B111E),
				new ColorCode("3004", 0x75151E), new ColorCode("3005", 0x5E2129), new ColorCode("3007", 0x412227),
				new ColorCode("3009", 0x642424), new ColorCode("3011", 0x781F19), new ColorCode("3012", 0xC1876B),
				new ColorCode("3013", 0xA12312), new ColorCode("3014", 0xD36E70), new ColorCode("3015", 0xEA899A),
				new ColorCode("3016", 0xB32821), new ColorCode("3017", 0xE63244), new ColorCode("3018", 0xD53032),
				new ColorCode("3020", 0xCC0605), new ColorCode("3022", 0xD95030), new ColorCode("3024", 0xF80000),
				new ColorCode("3026", 0xFE0000), new ColorCode("3027", 0xC51D34), new ColorCode("3031", 0xB32428),
				new ColorCode("3032", 0x721422), new ColorCode("3033", 0xB44C43), new ColorCode("4001", 0x6D3F5B),
				new ColorCode("4002", 0x922B3E), new ColorCode("4003", 0xDE4C8A), new ColorCode("4004", 0x641C34),
				new ColorCode("4005", 0x6C4675), new ColorCode("4006", 0xA03472), new ColorCode("4007", 0x4A192C),
				new ColorCode("4008", 0x924E7D), new ColorCode("4009", 0xA18594), new ColorCode("4010", 0xCF3476),
				new ColorCode("4011", 0x8673A1), new ColorCode("4012", 0x6C6874), new ColorCode("5000", 0x354D73),
				new ColorCode("5001", 0x1F3438), new ColorCode("5002", 0x20214F), new ColorCode("5003", 0x1D1E33),
				new ColorCode("5004", 0x18171C), new ColorCode("5005", 0x1E2460), new ColorCode("5007", 0x3E5F8A),
				new ColorCode("5008", 0x26252D), new ColorCode("5009", 0x025669), new ColorCode("5010", 0x0E294B),
				new ColorCode("5011", 0x231A24), new ColorCode("5012", 0x3B83BD), new ColorCode("5013", 0x1E213D),
				new ColorCode("5014", 0x606E8C), new ColorCode("5015", 0x2271B3), new ColorCode("5017", 0x063971),
				new ColorCode("5018", 0x3F888F), new ColorCode("5019", 0x1B5583), new ColorCode("5020", 0x1D334A),
				new ColorCode("5021", 0x256D7B), new ColorCode("5022", 0x252850), new ColorCode("5023", 0x49678D),
				new ColorCode("5024", 0x5D9B9B), new ColorCode("5025", 0x2A6478), new ColorCode("5026", 0x102C54),
				new ColorCode("6000", 0x316650), new ColorCode("6001", 0x287233), new ColorCode("6002", 0x2D572C),
				new ColorCode("6003", 0x424632), new ColorCode("6004", 0x1F3A3D), new ColorCode("6005", 0x2F4538),
				new ColorCode("6006", 0x3E3B32), new ColorCode("6007", 0x343B29), new ColorCode("6008", 0x39352A),
				new ColorCode("6009", 0x31372B), new ColorCode("6010", 0x35682D), new ColorCode("6011", 0x587246),
				new ColorCode("6012", 0x343E40), new ColorCode("6013", 0x6C7156), new ColorCode("6014", 0x47402E),
				new ColorCode("6015", 0x3B3C36), new ColorCode("6016", 0x1E5945), new ColorCode("6017", 0x4C9141),
				new ColorCode("6018", 0x57A639), new ColorCode("6019", 0xBDECB6), new ColorCode("6020", 0x2E3A23),
				new ColorCode("6021", 0x89AC76), new ColorCode("6022", 0x25221B), new ColorCode("6024", 0x308446),
				new ColorCode("6025", 0x3D642D), new ColorCode("6026", 0x015D52), new ColorCode("6027", 0x84C3BE),
				new ColorCode("6028", 0x2C5545), new ColorCode("6029", 0x20603D), new ColorCode("6032", 0x317F43),
				new ColorCode("6033", 0x497E76), new ColorCode("6034", 0x7FB5B5), new ColorCode("6035", 0x1C542D),
				new ColorCode("6036", 0x193737), new ColorCode("7000", 0x78858B), new ColorCode("7001", 0x8A9597),
				new ColorCode("7002", 0x7E7B52), new ColorCode("7003", 0x6C7059), new ColorCode("7004", 0x969992),
				new ColorCode("7005", 0x646B63), new ColorCode("7006", 0x6D6552), new ColorCode("7008", 0x6A5F31),
				new ColorCode("7009", 0x4D5645), new ColorCode("7010", 0x4C514A), new ColorCode("7011", 0x434B4D),
				new ColorCode("7012", 0x4E5754), new ColorCode("7013", 0x464531), new ColorCode("7015", 0x434750),
				new ColorCode("7016", 0x293133), new ColorCode("7021", 0x23282B), new ColorCode("7022", 0x332F2C),
				new ColorCode("7023", 0x686C5E), new ColorCode("7024", 0x474A51), new ColorCode("7026", 0x2F353B),
				new ColorCode("7030", 0x8B8C7A), new ColorCode("7031", 0x474B4E), new ColorCode("7032", 0xB8B799),
				new ColorCode("7033", 0x7D8471), new ColorCode("7034", 0x8F8B66), new ColorCode("7035", 0xD7D7D7),
				new ColorCode("7036", 0x7F7679), new ColorCode("7037", 0x7D7F7D), new ColorCode("7038", 0xB5B8B1),
				new ColorCode("7039", 0x6C6960), new ColorCode("7040", 0x9DA1AA), new ColorCode("7042", 0x8D948D),
				new ColorCode("7043", 0x4E5452), new ColorCode("7044", 0xCAC4B0), new ColorCode("7045", 0x909090),
				new ColorCode("7046", 0x82898F), new ColorCode("7047", 0xD0D0D0), new ColorCode("7048", 0x898176),
				new ColorCode("8000", 0x826C34), new ColorCode("8001", 0x955F20), new ColorCode("8002", 0x6C3B2A),
				new ColorCode("8003", 0x734222), new ColorCode("8004", 0x8E402A), new ColorCode("8007", 0x59351F),
				new ColorCode("8008", 0x6F4F28), new ColorCode("8011", 0x5B3A29), new ColorCode("8012", 0x592321),
				new ColorCode("8014", 0x382C1E), new ColorCode("8015", 0x633A34), new ColorCode("8016", 0x4C2F27),
				new ColorCode("8017", 0x45322E), new ColorCode("8019", 0x403A3A), new ColorCode("8022", 0x212121),
				new ColorCode("8023", 0xA65E2E), new ColorCode("8024", 0x79553D), new ColorCode("8025", 0x755C48),
				new ColorCode("8028", 0x4E3B31), new ColorCode("8029", 0x763C28), new ColorCode("9001", 0xFDF4E3),
				new ColorCode("9002", 0xE7EBDA), new ColorCode("9003", 0xF4F4F4), new ColorCode("9004", 0x282828),
				new ColorCode("9005", 0x0A0A0A), new ColorCode("9006", 0xA5A5A5), new ColorCode("9007", 0x8F8F8F),
				new ColorCode("9010", 0xFFFFFF), new ColorCode("9011", 0x1C1C1C), new ColorCode("9016", 0xF6F6F6),
				new ColorCode("9017", 0x1E1E1E), new ColorCode("9018", 0xD7D7D7), new ColorCode("9022", 0x9C9C9C),
				new ColorCode("9023", 0x828282) };
		
		// From http://wiki.creativecommons.org/Colors/
		public static final ColorCode CREATIVE_COMMONS_COLORS[] = { new ColorCode("Magenta 1", 0xf7b2cc),
				new ColorCode("Magenta 2", 0xb62b6e), new ColorCode("Magenta 3", 0x7b1b53),
				new ColorCode("Magenta 4", 0x4f1035), new ColorCode("Purple 1", 0xd6b4d6),
				new ColorCode("Purple 2", 0x9628c6), new ColorCode("Purple 3", 0x662978),
				new ColorCode("Purple 4", 0x42194f), new ColorCode("Blue 1", 0xbfceea),
				new ColorCode("Blue 2", 0x4374b7), new ColorCode("Blue 3", 0x214184), new ColorCode("Blue 4", 0x102548),
				new ColorCode("CC Green 1", 0xe0e4e1), new ColorCode("CC Green 2", 0xabb8af),
				new ColorCode("CC Green 3", 0x43594a), new ColorCode("CC Green 4", 0x2a372f),
				new ColorCode("Green 1", 0xe4eba0), new ColorCode("Green 2", 0x98c807),
				new ColorCode("Green 3", 0x627d0f), new ColorCode("Green 4", 0x3d5024),
				new ColorCode("Sand 1", 0xebe0b2), new ColorCode("Sand 2", 0xb1a24a), new ColorCode("Sand 3", 0x6d6118),
				new ColorCode("Sand 4", 0x44411f), new ColorCode("NC Yellow 1", 0xfff3a2),
				new ColorCode("NC Yellow 1", 0xedd812), new ColorCode("NC Yellow 2", 0xb09a11),
				new ColorCode("NC Yellow 3", 0x4e4917), new ColorCode("Orange 1", 0xffd89e),
				new ColorCode("Orange 2", 0xef9421), new ColorCode("Orange 3", 0xa46810),
				new ColorCode("Orange 4", 0x543d03), new ColorCode("Red 1", 0xfab499), new ColorCode("Red 2", 0xd13814),
				new ColorCode("Red 3", 0x912b10), new ColorCode("Red 4", 0x5a1c0e), new ColorCode("Grey 1", 0xededee),
				new ColorCode("Grey 2", 0xdcddde), new ColorCode("Grey 3", 0xa7a9ac), new ColorCode("Grey 4", 0x636466),
				new ColorCode("Grey 5", 0x393839), new ColorCode("Grey 5", 0x121513) };
	}
