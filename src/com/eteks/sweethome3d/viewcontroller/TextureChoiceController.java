...
public class TextureChoiceController implements Controller
{
	...
	public TextureChoiceController(String title, UserPreferences preferences, ViewFactory viewFactory,
			ContentManager contentManager)
	{
		this(title, true, preferences, viewFactory, contentManager);
	}
	
	public TextureChoiceController(String title, boolean rotationSupported, UserPreferences preferences,
	...
	{
		new ImportedTextureWizardController(textureName, this.preferences, this.viewFactory, this.contentManager)
				.displayView(getView());
	}
	...
	{
		new ImportedTextureWizardController(texture, this.preferences, this.viewFactory, this.contentManager)
				.displayView(getView());
	}
