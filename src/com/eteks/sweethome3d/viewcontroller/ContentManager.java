...
public interface ContentManager
{
	 ...
	 */
	public abstract String getPresentationName(String contentLocation, ContentType contentType);
	
	/**
	 * Returns <code>true</code> if the content location in parameter is accepted
	 * for <code>contentType</code>.
	 */
	public abstract boolean isAcceptable(String contentLocation, ContentType contentType);
	 ...
	 * @return the chosen content location or <code>null</code> if user canceled its choice.
	 */
	public abstract String showSaveDialog(View parentView, String dialogTitle, ContentType contentType,
			String location);
}
