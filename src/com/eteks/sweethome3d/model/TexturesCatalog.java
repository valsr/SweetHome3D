...
public class TexturesCatalog
{
	...
	private final CollectionChangeSupport<CatalogTexture> texturesChangeSupport = new CollectionChangeSupport<CatalogTexture>(
			this);
	...
	public void add(TexturesCategory category, CatalogTexture texture)
	{
		...
		this.texturesChangeSupport.fireCollectionChanged(texture, category.getIndexOfTexture(texture),
