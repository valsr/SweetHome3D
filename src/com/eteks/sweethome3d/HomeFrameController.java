...
public class HomeFrameController implements Controller
{
	...
	public HomeFrameController(Home home, HomeApplication application, ViewFactory viewFactory,
	...
	public HomeController getHomeController()
	{
		...
		{
			this.homeController = new HomePluginController(this.home, this.application, this.viewFactory,
					this.contentManager, this.pluginManager);
		}
